...
def GetErrorIP(input_file_name2, output_file_name2):
    ...
    fout.write("nginx 报错总数:%s " % len(errs) + sep)

    # fout.write("nginx error总数:%s "% len(errorL) + sep)
    x = len(errs) - len(ip_list)
...
if __name__ == '__main__':
    ...
    output_file_name = "./output_access.txt"
    GetAccessIp(input_file_name, output_file_name)
    # input_file_name2 = "./error.log"
    # output_file_name2 = "./output_error.txt"
